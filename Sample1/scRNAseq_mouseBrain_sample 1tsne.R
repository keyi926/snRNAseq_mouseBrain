...
################### start from .rds############################
###############################################################
mousebrain <- readRDS("/Users/keyi/Documents/1_Data/single_cell_Sequencing/Single_cell_seq/R/Sample1/mousebrain_tsne.rds")
mousebrain.markers <- readRDS("/Users/keyi/Documents/1_Data/single_cell_Sequencing/Single_cell_seq/R/Sample1/mousebrain_markers.rds")
